...
class AdminReOccurOrdersController extends ModuleAdminController

{
...

	{
		...
		JOIN `'._DB_PREFIX_.'skybankaim_autoship_order` ao ON (ao.`id_order` = a.`id_order`)
...

	{
...

		{
			...
			if (Validate::isLoadedObject($module) && $module->active)
				...
				$payment_methods[] = "SkyBank Subscription";
		...
		// get Reoccurring period

		$frequency = $this->module->getReoccurring((int)Tools::getValue('id_order'));
