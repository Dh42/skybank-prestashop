...
<form name="skybankaim_form" id="skybankaim_form" action="{$module_dir|escape:'html'}validation.php" method="post">
 ...
 <span style="border: 1px solid #595A5E;display: block;padding: 0.6em;text-decoration: none;margin-left: 0.7em;">
  ...
  {if ($isFailed == 0 || $isFailed == 2) && !$skybankaim_display_open}						
	 ...
	 <select id="skybank_cardType" name="x_cardType" style="width:185px;">					
	  ...
	  {/section}				
		...
		<p class="checkbox">
			...
			<label style="margin-top: 4px; margin-left: 35px; display: block; width: 260px; float: left;color:black;font-weight:bold;" for="toggle-autoship">{l s='Would you like to Subscription this order?' mod='skybankaim'}</label>
		...
		<h4 style="text-align: center;">{l s='Set this Order to Subscription' mod='skybankaim'}</h4>
