	...
	<div class="container-command">
		...
		<div style="width: 49%; float:left;">
			...
			<fieldset>
		        ...
		        <div class="panel">
		        	<div class="panel-heading">Auto-Ship Info</div>
					...
					<form action="" method="POST" class="defaultForm form-horizontal">
						<div class="form-group">
							...
							<div class="col-lg-3" style="width:400px;">
								 ...
								 <input class="button" type="submit" name="submitAutoship" value="{l s='Change Frequency'}">
								 <input class="button" type="submit" name="cancelAutoship" value="{l s='Cancel Auto-Ship'}">
							</div>
						</div>
